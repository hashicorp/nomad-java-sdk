...
public class CSIVolumesApi extends ApiBase {
     ...
     * @throws IOException    if there is an HTTP or lower-level problem
     * @throws NomadException if the response signals an error or cannot be deserialized
     * @see <a href="https://www.nomadproject.io/api-docs/volumes/#list-volumes">{@code GET /v1/jobs}</a>
     */
    public ServerQueryResponse<List<CsiVolumeListStub>> list(
            @Nullable final String pluginId
    ) throws IOException, NomadException {
     ...
     * @throws IOException    if there is an HTTP or lower-level problem
     * @throws NomadException if the response signals an error or cannot be deserialized
     * @see <a href="https://www.nomadproject.io/api-docs/volumes/#read-volume">{@code GET /v1/jobs}</a>
     */
